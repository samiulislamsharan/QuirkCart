<template>
    <section class="p-3 bg-gray-50 dark:bg-gray-900 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit Product' : 'Add Product'" width="650"
            ...
            <form class="mx-auto" @submit.prevent="AddProduct()">
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <button @click="openEditModal(product)"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</button>
                                            </li>
                                        </ul>
                                        <div class="py-1">
                                            <a href="#"
